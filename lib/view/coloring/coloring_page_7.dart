...
class _Example7State extends State<Example7> {
  ...
  List<Color> colors = [
    ...
    const Color.fromARGB(255, 108, 198, 240),
    Colors.lightGreen.shade600,
    const Color.fromARGB(255, 5, 121, 174),
    const Color.fromARGB(255, 3, 150, 57),
    const Color.fromARGB(255, 148, 103, 86),
   const Color.fromARGB(255, 231, 65, 195),
    const Color.fromARGB(255, 155, 46, 137),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 300.w,
                                        image:
                                            'assets/images/coloring/coloring_page_7/octupus.jpeg')
                                  ]),
                            ),
                          ),
                        ],
