...
class _Example6State extends State<Example6> {
  ...
  List<Color> colors = [
   const Color.fromARGB(255, 255, 232, 28),
    const Color.fromARGB(255, 177, 151, 109),
    const Color.fromARGB(255, 106, 182, 245),
    Colors.lightGreen.shade600,
    const Color.fromARGB(255, 129, 93, 79),
    const Color.fromARGB(255, 11, 122, 52),
    const Color.fromARGB(255, 79, 97, 201),
    const Color.fromARGB(255, 229, 60, 48),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 300.w,
                                        image:
                                            'assets/images/coloring/coloring_page_6/parrot.jpeg')
                                  ]),
                            ),
                          ),
                        ],
