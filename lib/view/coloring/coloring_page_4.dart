...
class _Example4State extends State<Example4> {
  ...
  List<Color> colors = [
    ...
    const Color.fromARGB(255, 246, 139, 52),
    Colors.brown.shade600,
    Colors.lightGreen.shade600,
    const Color.fromARGB(255, 108, 198, 240),
    const Color.fromARGB(255, 15, 139, 21),
    const Color.fromARGB(255, 5, 121, 177),
    const Color.fromARGB(255, 244, 127, 201),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 300.w,
                                        image:
                                            'assets/images/coloring/coloring_page_4/rabbit.jpeg')
                                  ]),
                            ),
                          ),
                        ],
