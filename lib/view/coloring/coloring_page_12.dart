...
class _Example12State extends State<Example12> {
  ...
  List<Color> colors = [
    ...
    const Color.fromARGB(255, 201, 148, 105),
    const Color.fromARGB(255, 238, 231, 170),
    const Color.fromARGB(255, 13, 143, 60),
    Colors.lightGreen.shade600,
    const Color.fromARGB(255, 126, 183, 230),
    const Color.fromARGB(255, 43, 108, 182),
    const Color.fromARGB(255, 4, 116, 45),
    const Color.fromARGB(255, 136, 100, 87),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 250.w,
                                        image:
                                            'assets/images/coloring/coloring_page_12/crocodile.jpeg')
                                  ]),
                            ),
                          ),
                        ],
