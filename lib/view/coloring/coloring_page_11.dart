...
class _Example11State extends State<Example11> {
  ...
  List<Color> colors = [
    const Color.fromARGB(255, 245, 116, 30),
    const Color.fromARGB(255, 238, 231, 170),
    const Color.fromARGB(255, 71, 88, 180),
    Colors.lightGreen.shade600,
    Colors.green.shade800,
    const Color.fromARGB(255, 216, 195, 8),
    const Color.fromARGB(255, 64, 102, 57),
    const Color.fromARGB(255, 72, 175, 223),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 250.w,
                                        image:
                                            'assets/images/coloring/coloring_page_11/turtle.jpeg')
                                  ]),
                            ),
                          ),
                        ],
