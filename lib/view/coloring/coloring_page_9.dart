...
class _Example9State extends State<Example9> {
  ...
  List<Color> colors = [
    ...
    Colors.amber,
    const Color.fromARGB(255, 163, 135, 97),
    Colors.orange.shade800,
    Colors.lightGreen.shade600,
    Colors.brown.shade600,
    Colors.green.shade700,
    const Color.fromARGB(255, 232, 157, 208),
    const Color.fromARGB(255, 115, 205, 247),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    CommonImageContainer(
                                        ...
                                        width: 300.w,
                                        image:
                                            'assets/images/coloring/coloring_page_9/lion.jpeg')
                                  ]),
                            ),
                          ),
                        ],
